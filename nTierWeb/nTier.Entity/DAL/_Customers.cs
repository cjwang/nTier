...
{
	public abstract class _Customers : SqlClientEntity
	{
		public _Customers()
		{
			this.QuerySource = "Customers";
			this.MappingName = "Customers";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_CustomersLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(string CustomerID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_CustomersLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[CustomerID] = _Customers.PropertyNames.CustomerID;
					ht[CompanyName] = _Customers.PropertyNames.CompanyName;
					ht[ContactName] = _Customers.PropertyNames.ContactName;
					ht[ContactTitle] = _Customers.PropertyNames.ContactTitle;
					ht[Address] = _Customers.PropertyNames.Address;
					ht[City] = _Customers.PropertyNames.City;
					ht[Region] = _Customers.PropertyNames.Region;
					ht[PostalCode] = _Customers.PropertyNames.PostalCode;
					ht[Country] = _Customers.PropertyNames.Country;
					ht[Phone] = _Customers.PropertyNames.Phone;
					ht[Fax] = _Customers.PropertyNames.Fax;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[CustomerID] = _Customers.ColumnNames.CustomerID;
					ht[CompanyName] = _Customers.ColumnNames.CompanyName;
					ht[ContactName] = _Customers.ColumnNames.ContactName;
					ht[ContactTitle] = _Customers.ColumnNames.ContactTitle;
					ht[Address] = _Customers.ColumnNames.Address;
					ht[City] = _Customers.ColumnNames.City;
					ht[Region] = _Customers.ColumnNames.Region;
					ht[PostalCode] = _Customers.ColumnNames.PostalCode;
					ht[Country] = _Customers.ColumnNames.Country;
					ht[Phone] = _Customers.ColumnNames.Phone;
					ht[Fax] = _Customers.ColumnNames.Fax;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_CustomersInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_CustomersUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_CustomersDelete]";
